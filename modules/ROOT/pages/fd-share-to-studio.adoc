...
You'll need to use *Export project sources* to share just your project source files (including all the connector credentials)
without all of the other artifacts that are required by the Mule runtime.

As the other person works on the project, they can take advantage of the advanced features of Studio.
When they are finished, they can choose to deploy the project from Studio.
...
The person who works in Studio can work on the project. When the work in Studio is completed, ensure that the project is deleted from Studio.
If you need help again later, repeat the procedure to share your project.
