...
The only thing you'll need to decide and communicate is whether you are exporting the source files only or the entire Mule app that includes all the connector credentials
and artifacts required by the Mule runtime.
...
+
A `.jar` file that contains just your project sources or a copy of your entire project including your credentials is downloaded to the default location on your computer.
