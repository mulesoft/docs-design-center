...
The only thing you'll need to decide and communicate is whether you are exporting the source files only or the entire Mule app which includes all the connector credentials
...
+
A `.jar` file that contains just your project source files, or a copy of your entire project (including all the connector credentials and artifacts)
is downloaded to the default location on your computer.
