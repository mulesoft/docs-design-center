= Get Help with a Project from Someone who Works in Studio
...
As the other person works on the project, the changes are applied to your project online in Design Center. When the other person is finished, you can open your project in Flow Designer and pick up where that person left off.
...
.. Enable Studio to access your organization from Studio by selecting *Preferences* > *Anypoint Studio* > *Authentication* and entering your user ID and password for Anypoint Platform.
...
Delete the project from Studio. If you need help again later, repeat the procedure to share your project.
