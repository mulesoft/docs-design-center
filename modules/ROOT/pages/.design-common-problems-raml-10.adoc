...
If you open in the API editor a published API specification that is written in RAML 1.0 and you see error or warning indicators, this list might help you to resolve the problems in your RAML.
