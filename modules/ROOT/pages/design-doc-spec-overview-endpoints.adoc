...
. If an endpoint implements a collection, this generated text appears: "_Implements <collection>_". You do not need to add this text to your specifications.
...
. The generated heading for the list of methods. You do not need to add this text to your specifications.
. The list of HTTP methods that are defined for accessing the endpoint. The colored blocks are generated. Click the block for a method to view the documentation for that method.
+
