...
The fifth indicator points to the information for one of the methods that are defined for accessing the resource at the endpoint. The colored blocks are generated. Click the block for a method to view the documentation for that method.
