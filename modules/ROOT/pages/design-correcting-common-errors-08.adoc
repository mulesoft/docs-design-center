...
When testing the new parser, MuleSoft identified ten common errors in API specifications written in RAML 0.8. The errors are explained with examples below.
