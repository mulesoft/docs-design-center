...
When testing its new RAML parser (which was release on October 24, 2018), MuleSoft identified eight common errors in API specifications written in RAML 1.0. The errors are explained with examples below. They are not listed in any particular order, such as frequency of occurrence in the sample of API specifications that MuleSoft tested.
