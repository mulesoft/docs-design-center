...
Timeout:: Specifies the maximum time in milliseconds that the entire scope of a Parallel For-Each component can take to complete processing all of the elements in a collection.
