...
4. Need to mention that the whole point of using the Documentation pane is to see how the structure and content of the specification will appear to users of Exchange, who will be able to view the spec with the same sort of UI.
