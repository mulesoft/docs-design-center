...
A flow consists of cards that are in a sequence from left to right. The cards each represent a core component, an operation of a connector, a module, or an API.
