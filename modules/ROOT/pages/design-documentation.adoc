...
+
image::apid-apic-oas-3-summary.png["A list of API servers and endpoints with their available methods."]
...
+
image::apid-apic-oas-3-default.png["A dialog box with a server selection dropdown and a GET button."]
...
+
image::apid-apic-oas-3-default-get.png["An API documentation page with code examples and responses."]
...
+
image::apid-apic-oas-3-duplicated.png["A dropdown menu for choosing your server."]
...
+
image::apid-apic-oas-3-duplicated-get.png["An API documentation page demonstrating the GET method for duplicate data."]
...
+
image::apid-apic-oas-3-files.png["An API documentation page with instructions for file upload and download actions."]
...
+
image::apid-apic-oas-3-files-get.png["An API documentation page illustrating the GET method for file retrieval, complete with code examples and responses.]
...
+
image::apid-apic-oas-3-ping.png["An arrow points to a URL."]
...
+
image::apid-apic-oas-3-ping-get.png["A form with a server selection dropdown, a GET request button, and illustrative code snippets.]
...
+
image::apid-apic-oas-3-ping-post.png["a code snippet that demonstrates the post method for /ping."]
...
+
image::apid-apic-oas-3-links-1.png["Two tables with variable and expression columns.]
...
+
image::apid-apic-oas-3-links-2.png["A table that displays variables and their expressions."]
...
image::apid-apic-oas-3-callbacks.png["A list of API calls, including parameters, body, and responses."]
