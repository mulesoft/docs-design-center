...
. Click *Import*.
+
If one or more connectors referenced by the project are not available in your environment, then the import fails and a message lists the missing connectors. 
