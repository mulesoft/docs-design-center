...
[IMPORTANT]
====
An exported project does not include items that the project linked to in its original location.

For example, if the project contains a Database connector, the database driver for that connector is not included in the exported project. After you import the project, you must open the Database connector, browse to the location of the database driver, and select it.

If the project contains any connectors that require a driver or another type of library, you must open those connectors and select the required libraries.
====
