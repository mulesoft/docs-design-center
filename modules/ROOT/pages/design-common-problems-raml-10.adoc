...
:page-aliases: design-modify-raml-specs-conform.adoc

[[bookmark-a,Back to the top]]

When you write an API specification in RAML 1.0, you might inadvertently make a mistake that is common to a large number of other authors. Many of those common errors are explained below, along with tips for how to resolve them.
