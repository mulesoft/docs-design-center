...
The errors in this section both involve incorrect handling of type inheritance.
...
A subtype that defines a weaker constraint than one defined by its parent is invalid.
