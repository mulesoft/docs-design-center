...
== Common misconceptions about RAML NamedExample fragments and examples in general
// APIMF-907
...
* In the fragment, ensure that each example consists of a name and values for both properties, as in the fragment below:
+
.fragment.raml
----
