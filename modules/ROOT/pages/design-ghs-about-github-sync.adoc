...
Additionally, you can perform GitHub-specific actions from within the API Designer UI, for example, open pull requests, view branch diffs, view synchronization status, and resolve merge conflicts.
