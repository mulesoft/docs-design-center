...
To switch to the tab to the left of the currently open one by pressing Option + Shift + Tab (MacOS) or <what?> (Windows.

To switch to the tab to the right, press Shift + Tab (MacOS) or <what?> (Windows).
