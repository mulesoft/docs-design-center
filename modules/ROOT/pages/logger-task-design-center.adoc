= Log Data with Logger (Flow Designer)
...
You add one or more Logger core components to a flow to log information from the flow at runtime. Logging information is helpful for troubleshooting and taking a quick look at the output at some point in the flow. You can use expresssions to create the log message. The following table lists some examples.
