...
You might even find in the future that you need to create Mule applications that are similar to one that you've already created. Rather than seek out its project in Design Center, clone it, and then try to remember what it does and how it works, you can read the page that you wrote for the template in Exchange.
