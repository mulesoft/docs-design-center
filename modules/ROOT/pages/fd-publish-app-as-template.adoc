...
Sharing Mule applications as templates is a great way to share your work with other people. When they need to build a similar application, they can begin by downloading and using your template to start their own project. If you accompany your template in Exchange with a good description, screenshots, and perhaps even a video, those other people could get going even more quickly.
