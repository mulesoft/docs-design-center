...
As you deploy your application, you can change connector configurations and reconnection strategies. You must do this if there are differences between the Design environment and target environments that would necessitate such changes.
...
. If you want to change the way that any of the connectors in your application connect to systems, click *Advanced* to see a list of the configurations that the connectors in your application are using.
+
Select a configuration on the left to edit it.
