...
You can go to Runtime Manager to manage the application. To get there from Flow Designer, click the options menu to the left of the *Deploy* button and select *View in Runtime Manager*.
