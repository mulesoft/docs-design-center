...
== Select Code Blocks by Scope
“Selection Ranges” allow you to select and to expand the selection of code blocks inside the document. 

Selections conform to code block scope, meaning that if you select an element and increase the selection range, the code block scope will be selected. Likewise with decreasing selection range - the code block scope will be deselected.
