...
To publish, click the icon that is in the top-right corner of the visual API editor to open the *Publish API specification to Exchange* dialog. The icon looks like this:
