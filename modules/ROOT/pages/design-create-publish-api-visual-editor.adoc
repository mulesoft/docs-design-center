...
You can use Design Center's visual API editor to create RAML or OAS API specifications by populating language-neutral forms. When your specification is ready to be shared, either as a version ready for use or as a draft, you can publish it to Anypoint Exchange.
