...
If you are satisfied with your API specification, you can publish it to Exchange in RAML. To publish, click the *Publish to Exchange* button that is in the top-right corner of the visual API editor to open the *Publish API specification to Exchange* dialog. 
