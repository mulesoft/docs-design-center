= Create and Publish an API Specification with the Visual API Editor
...
== What to do next
After you are satisfied with your API specification, you can  publish it to Exchange. Click the icon that is in the top-right corner of the visual API editor to open the *Publish API specification to Exchange* dialog. The icon looks like this:
