...
+
You can import files into your project, either separately or bundled together in .zip files. The files can be RAML 1.0 files, JSON files, or OpenAPI Specification (OAS) 2.0 or 3.0._x_ files. The files can be on your computer or you can specify a URL for them if they are located online.
