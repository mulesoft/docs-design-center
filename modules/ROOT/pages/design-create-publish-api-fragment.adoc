...
You can create API fragments directly in RAML, with the help of code suggestions that appear within the text editor. To do so, you must first create an API-fragment project and save it either in Design Center or in GitHub as a repository.
...
. Create an API-fragment project:
.. On the *Projects* page in Design Center, click *Create* and select *Create Fragment*.
.. In the *New Fragment* dialog, type a name for the project.
+
