= Create and Publish a RAML API Fragment in the Code Editor in API Designer
...
You can publish the API fragment to Anypoint Exchange. Click the *Publish* button that is in the top-right corner of the code editor, and then click *Publish to Exchange* to open the *Publish API specification to Exchange* dialog.
