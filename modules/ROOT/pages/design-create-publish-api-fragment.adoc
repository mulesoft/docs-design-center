...
You can publish the API fragment to Anypoint Exchange. Click the *Publish to Exchange* button that is in the top-right corner of the API editor to open the *Publish API specification to Exchange* dialog.
