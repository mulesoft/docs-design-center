...
You can publish the API fragment to Anypoint Exchange. Click the *Publish* button that is in the top-right corner of the text editor, and then click *Publish to Exchange*. Specify a version number for the project, which Exchange treats as an _asset_. This number is displayed in Exchange in the *Version* section of the right-hand pane in the page for the project.

.The asset version of your API-fragment project appears in *Versions* section in the right pane of the asset page.
image:apid-location-of-asset-version-in-exchange.png[The location of the Versions section]

After you publish the API-fragment project, other developers can include its fragments as dependencies in API-specification projects.
