...
You can reuse a connection in a Flow Designer project instead of adding your authentication information manually. After a reusable connection is created, it is available for all Flow Designer projects in your business group. Changing your resuable configuration is can be done anytime. 
...
. View the list of your reusable connections. To help you choose the right connection the date the reusable connector was created is visible under the connection.
