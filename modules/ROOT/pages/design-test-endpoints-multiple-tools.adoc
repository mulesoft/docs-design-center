...
== Example Using `curl`
// 8/23/19: In a meeting that I had with him yesterday, Kieran said to include a simple example in curl. People who copy the code samples are likely to know already how to use them.
