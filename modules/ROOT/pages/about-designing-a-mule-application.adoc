...
. The panes
+
Click the top icon to open the *Project* pane, which lists a project's flows, the configurations that are being used, and any global data types that have been defined. Click the bottom icon to open the *Dependencies* pane, which lists a project's dependencies.
+
