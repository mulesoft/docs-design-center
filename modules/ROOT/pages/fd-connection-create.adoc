...
A connection is a saved set of information that a Mule app must use to connect to a specific system by means of a connector. You might create a connection as part of adding a connector to a flow.
...
.The *Database Configuration* dialog presents a list of connections to databases and an option for creating a connection to a database.
