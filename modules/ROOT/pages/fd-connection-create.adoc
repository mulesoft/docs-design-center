...
Flow Designer returns you to the configuration dialog for the connector. The connection that you added is selected as the connection for the configuration to use. Click *Save* to return to the canvas.
