...
* xref:4.1@mule4-runtime::scopes-concept.adoc[About Scopes]
* xref:4.1@mule4-runtime::try-scope-concept.adoc[About the Try Scope]
* xref:4.1@mule4-runtime::error-handling.adoc[Error Handling]