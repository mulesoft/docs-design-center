...
+
The stub specification file is listed and set as the root file of the project. You can change the name and extension of this file by right-clicking the three dots to the right of the name and selecting *Rename*.
+
