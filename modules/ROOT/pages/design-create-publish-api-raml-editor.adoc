...
. In the *New API Specification* dialog, name your project and select the option *Code editor* to use the code editor. You can also choose whether the stub specification file created in the project should be in RAML or OAS. The default is to create a RAML 1.0 file; however, you can change the file to RAML 0.8 or OAS after the project is created. In fact, projects for creating API specifications can contain a mix of RAML and OAS files.
+
...
Convert files:: Convert a file in your project to another format. Click the dots to the right of the file name and select *Convert*. You can convert your specification to one of the other supported formats. If your specification is in RAML, you can convert it to OAS in YAML or in JSON. If your specification is in OAS, you can convert it to RAML 0.8 or to RAML 1.0.
+
[WARNING]
====
