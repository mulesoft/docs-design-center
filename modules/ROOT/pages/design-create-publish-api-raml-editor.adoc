...
Text to add at line 17 when the GitHub integration is no longer "dark":
 ...
 +
 * If you save your project in Design Center, you or other people in your organization can fork your project in Design Center, as described in xref:design-branching.adoc[Fork a Project in the Text Editor].
 +
