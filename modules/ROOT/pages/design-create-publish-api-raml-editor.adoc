...
Export your API project or specification:: At any time, you can export your project as a `.zip` file. You can also export your specification in its current language or in one of the other supported languages. For more information, view the topic "Export Files from an API Project", which is linked to from the *See also* section at the end of this topic.
