 ...
 * If you save your project in Design Center, you or other people in your organization can fork your project in Design Center, as described in xref:design-branching.adoc[Fork a Project in the Code Editor].
 +
 * If you save your project in a repository in GitHub, you and other people in your organization who also have access to the repository can use GitHub's features to manage the project. See xref:apid-github-integration.adoc[Manage a Project in GitHub] for details.
...
== What to do next
After you are satisfied with your specification, you can publish it to Anypoint Exchange. Click the *Publish to Exchange* button that is in the top-right corner of the code editor to open the *Publish API Specification to Exchange* dialog.
