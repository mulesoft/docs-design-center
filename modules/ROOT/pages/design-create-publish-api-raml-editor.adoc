...
You can use API Designer's text editor to create API specifications directly in RAML 0.8, RAML 1.0, or OAS 2.0 (either in JSON or YAML). You can save the project in Design Center, or you can save it in GitHub as a repository.
