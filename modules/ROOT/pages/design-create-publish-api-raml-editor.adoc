...
You can use Design Center’s API editor create API specifications directly in RAML 0.8, RAML 1.0, or OAS 2.0 (either in JSON or YAML). When your specification is ready to be shared, either as a version ready for use or as a draft, you can publish it to Anypoint Exchange.
...
== What to do next
When you are satisfied with your specification, you can publish it to Anypoint Exchange to share it with other people. See xref:design-publish-to-exchange.adoc[Publish an API Specification or RAML Fragment to Exchange].
