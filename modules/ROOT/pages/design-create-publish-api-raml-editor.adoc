...
.. Select *Text editor*.
.. Choose whether the stub specification file created in the project should be in RAML or OAS.
+
The default is to create a RAML 1.0 file; however, you can change the file to RAML 0.8 or OAS after the project is created. In fact, projects for creating API specifications can contain a mix of RAML and OAS files.
