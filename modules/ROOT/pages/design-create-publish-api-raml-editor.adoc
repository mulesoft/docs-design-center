...
You can use API Designer's text editor to create API specifications directly in RAML 0.8, RAML 1.0, or OAS 2.0 (either in JSON or YAML).
...
. Create an API-specification project that you can work in.
 ...
 .. In the *New Specification* section of the dialog that is opened, name your project and select the option *Text editor* to use the text editor.
...
Export your API project or specification:: At any time, you can export your project as a `.zip` file. Click *Settings* in the top-right corner of the text editor and select *Download Project*.
...
== What to Do Next
After you are satisfied with your specification, you can publish it to Anypoint Exchange. Click the *Publish* button that is in the top-right corner of the text editor, and then click *Publish to Exchange* to open the *Publish API Specification to Exchange* dialog.
