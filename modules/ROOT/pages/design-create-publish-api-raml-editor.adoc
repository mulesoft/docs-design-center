...
Export your API project or specification:: At any time, you can export your project as a `.zip` file. Click *Settings* in the top-right corner of the code editor and select *Download Project*.
