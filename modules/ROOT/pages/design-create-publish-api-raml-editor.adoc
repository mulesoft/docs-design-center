= Create and Publish an API Specification with the Code Editor
...
== What to do next
Publish your API specification to Exchange. Click the icon that is in the top-right corner of the API editor to open the *Publish API specification to Exchange* dialog. The icon looks like this:
