...
:page-aliases: add-dependencies-task.adoc, design-api-basics-tasks.adoc, design-api-key-tasks.adoc, design-export-files.adoc, design-raml-api-task.adoc, design-update-remove-dep-task.adoc

You can use API Designer's text editor to create API specifications directly in RAML 0.8, RAML 1.0, OAS 2.0, OAS 3.0, AsyncAPI 2.6, and AsyncAPI 2.0. You can create OAS and AsyncAPI API specifications as JSON or YAML files.
...
WARNING: File uploads are restricted to supported formats. 
...
* xref:design-center::design-async-api.adoc[AsyncAPI Specifications]
