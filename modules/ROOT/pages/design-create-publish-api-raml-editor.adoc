...
You can use API Designer's text editor to create API specifications directly in RAML 0.8, RAML 1.0, OAS 2.0, OAS 3.0, AsyncAPI 2.6, and AsyncAPI 2.0. OAS and AsyncAPI API specifications can be created as JSON or YAML files.
