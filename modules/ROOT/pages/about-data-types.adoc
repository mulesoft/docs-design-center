...
When you build a flow, you must be aware of the structure of the data a) that each card requires as input, and b) that each card produces as output. The structure of the output of a card might not match the structure of the input that the next card requires.
