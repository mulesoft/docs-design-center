...
A _data type_ explains to Flow Designer the formats and structures of the data that are in inputs and outputs. There are two categories of data types that are supported in Flow Designer: simple and custom. See these topics for information about these categories of data types:
