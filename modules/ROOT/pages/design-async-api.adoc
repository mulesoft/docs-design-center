...
AsyncAPI is a language that describes messaging interfaces. This open-source, industry-standard language is agnostic to any technology. To learn more, see the https://www.asyncapi.com/docs/tutorials/getting-started[AsyncAPI documentation]. 
...
* https://www.asyncapi.com/docs/tutorials/getting-started[AsyncAPI]
