...
. Click *Settings* in the top-right corner of the editor and select *Import*.
...
** *In the code editor only:* Click *Settings* in the top-right corner of the editor and select *Import from Exchange*.
