...
* Import a file or the content of a .zip file that is stored on your computer, if you are using the code editor:
...
* Import a file that is available through a URL, if you are using the code editor:
...
+
** If you are using the code editor and your project contains only the default file that API Designer created together with the project, you can click the linked text that appears in the *Files* pane.
** If you are using the code editor, you can click *Settings* in the top-right corner of the code editor and select *Import from Exchange*.
