...
The *Documentation* pane presents the content of an API specification (including its fragments) or supported stand-alone fragment in structured display that includes the documentation that you write in `description` and `documentation` facets, and that also includes text that the pane generates.
