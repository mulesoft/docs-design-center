...
If you see this warning message in the API editor, then your API specification is incorrectly referencing a named example:
...
If you see this warning message in the API editor, then a NamedExample fragment is missing a name:
----
