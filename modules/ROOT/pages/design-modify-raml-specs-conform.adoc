...
>>>>>>> d8fd8f92cbf18a9e36829d494f47a6c5b76811ce
...
<<<<<<< HEAD
You will have a grace period of at least one year to correct any invalid RAML that your published API specifications might include. After that grace period expires, you will be unable to republish and redeploy APIs in which there is invalid RAML.
=======
