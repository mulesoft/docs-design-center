...
*Update posted on January 11, 2020:* As of January 10, 2020, you cannot publish or deploy API specifications that contain invalid RAML or invalid regular expressions.
====
