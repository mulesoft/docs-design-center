...
. Click the *Governance auto-validation* icon (image:green-governance-auto-validation.png[width=16px,height=16px,title="Governance auto-validation"]) to disable auto-validation.
. Click the *Validate for governance* icon (image:validate-for-governance.png[width=16px,height=16px,title="Validate for governance"]) to enable manual validation. 
+
...
. In the *Project Errors* section of the text editor, select the *Governance* tab. 
. Click the auto-validation icon (image:red-governance-auto-validation.png[width=16px,height=16px,title="Governance auto-validation"]) to enable auto-validation again.
