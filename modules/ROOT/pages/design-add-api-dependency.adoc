...
In projects for API specifications or API fragments, you can add dependencies of either API fragments (RAML), OAS components, JSON schemas, or rulesets. Because the dependencies are referenced in Anypoint Exchange, you cannot directly edit them in your projects.
