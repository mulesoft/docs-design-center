...
You can switch between auto-validation and manual validation in your API project. 

To turn on manual validation of your rulesets:

. In the *Project Errors* section of the text editor, select the *Governance* tab. 
. Click the auto-validation icon (image:green-governance-auto-validation.png[width=0.90%,height=0.90%,title="Governance auto-validation"]) to disable auto-validation.
. Click the validate icon (image:validate-for-gorvernance.png[width=0.90%,height=0.90%,title="Validate for governance"]) to enable manual validation. 
+
...
. In the *Project Errors* section of the text editor, select the *Governance* tab. 
. Click the auto-validation icon (image:green-governance-auto-validation.png[width=0.90%,height=0.90%,title="Governance auto-validation"]) to enable auto-validation again.
