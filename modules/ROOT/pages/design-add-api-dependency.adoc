...
Rulesets are validated automatically by default.

To turn manual validation of your rulesets on:

* Click *Governance auto-validation* in the *Governance* tab of the *Project Errors* section of the text editor to disable auto-validation. 
* Then, click *Validate for Governance* in the *Governance* tab of the *Project Errors* section of the text editor. 
