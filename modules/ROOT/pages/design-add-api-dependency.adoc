...
. Click the validate icon (image:validate-for-governance.png[width=0.90%,height=0.90%,title="Validate for governance"]) to enable manual validation. 
+
...
. In the *Project Errors* section of the text editor, select the *Governance* tab. 
. Click the auto-validation icon (image:red-governance-auto-validation.png[width=0.90%,height=0.90%,title="Governance auto-validation"]) to enable auto-validation again.
