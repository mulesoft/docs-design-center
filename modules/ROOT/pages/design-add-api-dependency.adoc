...
<<<<<<< Updated upstream
If the automatic validation process takes too long, you get a warning that auto-validation is disabled for the project. Click *Ok* to change to manual mode.
If you don't want to disable auto-validation, click *Cancel*. 
