...
* Select a branch: The current GitHub branch appears first (with its commit hash), followed by a list of previously created feature branches. Click a branch name to switch to branch. 
* View differences between branches: Click *View Diff* to view differences between a branch and the current branch.
+
