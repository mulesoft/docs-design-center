...
* The administrator permission to access the GitHub organization (as configured through GitHub account settings)
...
To install the GitHub Synchronization application:
