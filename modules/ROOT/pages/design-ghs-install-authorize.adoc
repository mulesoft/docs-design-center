...
* The GitHub integration supports only non-enterprise accounts. For more information, refer to https://docs.github.com/en/enterprise-cloud@latest/get-started/learning-about-github/types-of-github-accounts[Types of Github Accounts].
