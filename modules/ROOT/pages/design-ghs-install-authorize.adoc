...
[IMPORTANT]
In the email settings for the GitHub account you want to use with GitHub Synchronization, ensure you have not selected *Block command line pushes that expose my email*, as this will prevent you from pushing commits in your synchronized project.
