...
+
Click the arrow in the data pill to see a list of the functions that you can apply to the value. The functions are applied in the order in which you select them.
+
