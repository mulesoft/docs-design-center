...
+
Click the arrow in the data pill to see a list of the functions that you can apply to the value. You can also see a preview of the value, whether or not any functions are applied to it. If the application is not running, the preview comes from the example that was specified for the data type the data type was defined. If the application is running, the preview can show live data.
+
