...
Also, if you want to change the value, click the down arrow in the element to see a list of the functions that you can choose from. For example, for a text value you can choose from transformations to lower case or to upper case. Select one of the functions to see a preview of the change, as in the following image.
====
+
image::vfe-preview-2.png[]
