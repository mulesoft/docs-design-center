...
All that you have to do is to drag and drop into a text field any payload items, attributes, and variables that you want to include. You can pull the elements that you can drag-and-drop from the right side of a connector into multi-line fields.
