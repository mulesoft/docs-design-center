...
All that you have to do is to drag and drop into a text field any payload items, attributes, and variables that you want to include. You can add multiple lines of text and expressions in the message field.
