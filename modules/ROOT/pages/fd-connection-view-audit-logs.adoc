...
You can also download the payload for an entry in the audit log. A payload for the creation, modification, or deletion of a connection includes the ID of the connection, the ID of the user that created the connection, the type of connector that the connection was created for, and more.
