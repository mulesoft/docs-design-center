= Create a DataWeave Expression in a Card (Flow Designer)
...
. If the field is a text field, click `Custom Expression` in the list on the right side of the card and drag it into the text field.
+
[NOTE]
====
