...
Click the overview page for an endpoint to see its description and a list of its methods. For each method, the *Documentation* pane shows the display name and description. Click on the colored box for a method or its display name (if the method has one) to view the method's documentation.
...
image::apid-doc-full-panel-get-overview.png[float="left"]

== Documentation for Types

image::apid-doc-type-full-panel.png[float="left"]
