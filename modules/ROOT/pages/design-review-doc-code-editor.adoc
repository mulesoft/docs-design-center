...
. Navigation icon: click this to display a pane that lets you navigate to the different overview pages of the documentation. The table of contents that appears contains three sections:
...
image::apid-list-of-endpoints.png[float="left"]

image::apid-list-of-types.png[float="left"]
These two images display the lists of endpoints and types that are in a complex specification. When you click the navigation icon, these lists appear in a single pane. The image on the left shows what appears at the top of the pane for this specification, and the image on the right shows the start of the list of types, which you can see either by scrolling down the pane or by collapsing the *Endpoints* section.

The list of endpoints appears first, and the list of types appears after that. Expand an endpoint to see links to its overview page and the overview pages for the endpoints methods. Click a type to go directly to its overview page.
