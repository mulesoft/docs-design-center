...
* Sign up for a 30-day trial of xref::https://anypoint.mulesoft.com/login/signup[MuleSoft Anypoint Platform], if you do not already have access to it.
...
.. In the *Connection Type* field, select *Basic Username Password*.
