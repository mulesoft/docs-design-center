...
. Click the plus sign between the Salesforce card and the Transform card to add a new component.
...
.. Click the plus sign that is between the Set Variable card and the Transform card.
...
.. Click the three dots in the first subcard and select *Add Below*. The current subcard closes and another opens beneath it.
...
.. Click the plus icon next to the Enterprise subcard and add a Database card.
...
.. Add a Database card after the Small Business subcard.
+
[NOTE]
====
