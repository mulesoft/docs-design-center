...
* Sign up for xref::https://www.twilio.com/try-twilio[a free Twilio developer account]. You'll need the trial phone number that Twilio provides for your account. You'll also need your account SID and authentication token.
...
. Click the plus sign to the right of the Choice router block and add a Transform component.
. Set the data types for the values on the left side.
...
. On the right side of the Transform card, set the data type for `payload` to `Order Information`.
+
