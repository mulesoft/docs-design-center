...
<3> *LifeCycle State*: The lifecycle state of the asset. Assets can be published from API Designer in the *Development* state or *Stable* state. 
...
NOTE: If you are using the non-crowd version of Anypoint Platform and want to add the asset to API Manager while publishing to Exchange, select *Add to API Manager*. This option is not available if you are using the crowd version.
