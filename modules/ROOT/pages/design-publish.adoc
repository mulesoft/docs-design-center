...
Anypoint Exchange requires that each API specification published to it have a version number. The content and state of the *API version* field on the publish dialog depends on the following:
