...
<5> *Asset name*: The name that Anypoint Exchange uses to identify the published project. You should typically use the default name. 
<6> *Asset ID*: The ID that Anypoint Exchange uses to identify the published project. You should typically use the default ID.
+
