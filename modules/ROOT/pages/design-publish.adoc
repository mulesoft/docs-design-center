...
* If you are republishing the specification and select `Development`, you can use the same number as a previously published in-development version of the API, but not the same number as a previously published stable version.
