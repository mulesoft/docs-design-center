...
You can set any fragment in an API-fragment project as the root file of that project. For example, the following image shows that a project contains two fragments, the second of which is set as the root file:

.This API-fragment project includes two fragments. The second is set as the root file.
