...
You can design, document, and share API specifications and fragments in all supported languages. You can test RAML and OAS specifications. 

== Designing

You can use either the text editor or the visual editor to create API specifications in all supported languages.
...
* Preview an APIs functionality before writing a single line of code.
...
* Anypoint Studio can even import a specification directly from API Designer.
