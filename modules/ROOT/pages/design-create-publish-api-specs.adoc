...
You can use two different tools in API Designer -- the text editor and the visual editor -- to create API specifications in RESTful API Modeling Language (RAML) version 0.8 or 1.0, or according to OpenAPI specification (OAS) version 2.0 or 3.0._x_.
