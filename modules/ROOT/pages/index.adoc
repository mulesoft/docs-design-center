...
NOTE: Flow Designer is https://www.mulesoft.com/legal/versioning-back-support-policy[end of life] and its documentation is now located at https://archive.docs.mulesoft.com/design-center/index[Flow Designer archive site].
