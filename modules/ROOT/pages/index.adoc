...
Anypoint Design Center is a development environment. xref:design-create-publish-api-specs.adoc[API Designer] enables you to create API specifications in several modeling languages and create RAML API fragments. After you create a specification or fragment, publish it to Anypoint Exchange for anyone in your MuleSoft organization to use.
