...
Anypoint Design Center is a development environment that includes xref:about-designing-a-mule-application.adoc[Flow Designer], a tool that enables you to create Mule applications to integrate systems into workflows.
