...
[NOTE]
====
Design Center's public, mocked URI is also visible in Exchange. There, people who discover your API can try it out by using the built-in Exchange mocking service, or by using the public URI in their own code or in their API testing tool of choice.
====
