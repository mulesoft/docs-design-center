...
. Select *New AsyncAPI*.
+
image::platform/anypoint-create-asyncapi.png[The Create menu with the AsyncAPI option shown]
...
+
image::platform/apid-import.png[The Settings menu with the Import options shown]
+
